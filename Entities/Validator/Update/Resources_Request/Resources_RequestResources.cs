...
namespace Entities
{
    public class Resources_RequestResources : AbstractValidator<Resources_RequestResources_Materials_Medicines_VehiclesForCreationDto>
    {
        ...
        public Resources_RequestResources()
        {
